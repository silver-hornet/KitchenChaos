...
{
    [Serializable]
    public struct KitchenObjectSO_GameObject // Just storing some data without any logic, so a struct instead of a class seems appropriate, although a class would work just as well.
    {
